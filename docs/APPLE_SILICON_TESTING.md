...
curl -L -o "$tmpdir/PressTalk-0.1.5-rc86-macos-arm64.zip" \
  https://github.com/subtract0/presstalk/releases/download/v0.1.5-rc86/PressTalk-0.1.5-rc86-macos-arm64.zip
echo "eb92d4de449f81fdbcad6c9342c190f16c91c202243ef37c68b3a98cd266bafb  $tmpdir/PressTalk-0.1.5-rc86-macos-arm64.zip" | shasum -a 256 -c -
ditto -x -k "$tmpdir/PressTalk-0.1.5-rc86-macos-arm64.zip" "$tmpdir"
...
```text
eb92d4de449f81fdbcad6c9342c190f16c91c202243ef37c68b3a98cd266bafb
```
