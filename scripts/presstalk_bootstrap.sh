...
OPEN_ENV_ARGS="$(
  ...
  open_env_arg PRESSTALK_PARAKEET_QUALITY_FALLBACK "$PRESSTALK_PARAKEET_QUALITY_FALLBACK"
  open_env_arg PRESSTALK_PARAKEET_MIN_CONFIDENCE "$PRESSTALK_PARAKEET_MIN_CONFIDENCE"
...
- Streaming ASR backend: $PRESSTALK_STREAMING_ASR_BACKEND
- Streaming transcription: $PRESSTALK_ENABLE_STREAMING_TRANSCRIPTION
- Parakeet quality fallback: $PRESSTALK_PARAKEET_QUALITY_FALLBACK
- Parakeet min confidence: $PRESSTALK_PARAKEET_MIN_CONFIDENCE
